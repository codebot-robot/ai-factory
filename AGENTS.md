...
10. **Tools:** Executable tools that agents can use are stored in the `tools/` directory. For example, `tools/run-subagent` is used to run a subagent within a long-running agent sandbox.
